...
class x {
  ...
  #p() {
    ...
    // Test WebGL support on an offscreen dummy canvas so main canvas context is unlocked
    try {
      const testCanvas = document.createElement('canvas');
      const gl = testCanvas.getContext('webgl2') || testCanvas.getContext('webgl');
      if (!gl) {
        console.warn('Ballpit: WebGL context is unavailable in this environment.');
        this.renderer = null;
        return;
      }
    } catch (err) {
      console.warn('Ballpit: WebGL context check failed:', err);
    }
    ...
    try {
      ...
      console.warn('Ballpit WebGLRenderer initialization failed:', err);
      this.renderer = null;
    }
  }
  #g() {
