...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(26, 73, 147, 0.4) 0%, rgba(6, 182, 212, 0.2) 100%)';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    ...
    [iconUrl, grainUrl, innerGradient, behindGlowColor, behindGlowSize, style]
  );
            ...
            <div className="pc-content pc-avatar-content">
              ...
              {showUserInfo && (
                <div className="pc-user-info">
                  ...
                  <button
                    className="pc-view-more-btn"
                    onClick={handleViewMoreClick}
                    style={{ pointerEvents: 'auto' }}
                    type="button"
                    aria-label={`View more details about ${name || 'user'}`}
                  >
                    View More
                  </button>
                </div>
